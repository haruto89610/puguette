...
#                    i+=1
            ...
            if speed != 0 or angle != 0:
                if T <= 0:
                    ...
                    coords[1][0], coords[1][2] = Walk.bezier(T) # FL
                    coords[1][2] = coords[1][2]
                    coords[3][2] = coords[3][2]

                    coords[0][0], coords[0][2] = ((-xPoints[11]/ratio)+(xPoints[0]/ratio))*T+xPoints[11]/ratio, -0.4 # FR
                    coords[2][0], coords[2][2] = ((xPoints[11]/ratio)-(xPoints[0]/ratio))*(T+0.5)+xPoints[0]/ratio, -0.4 # BR

                    T += speed
                elif T > 0.5 and T<= 1:
                    coords[1][0], coords[1][2] = Walk.bezier(T)
                    coords[2][0], coords[2][2] = Walk.bezier(1.5-T) # gait ends at T=1.5 and leg orientation is inverted
                    coords[1][2] = coords[1][2]
                    coords[2][2] = coords[2][2]

                    coords[0][0], coords[0][2] = ((-xPoints[11]/ratio)+(xPoints[0]/ratio))*T+xPoints[11]/ratio, -0.4
                    coords[3][0], coords[3][0] = ((xPoints[11]/ratio)-(xPoints[0]/ratio))*(T-0.5)+xPoints[0]/ratio, -0.4

                    T += speed
                elif T > 1 and T <= 1.5:
                    coords[2][0], coords[2][2] = Walk.bezier(1.5-T)
                    coords[0][0], coords[0][2] = Walk.bezier(T-1) # gait starts at T=1 and leg orientation is not inverted
                    coords[2][2] = coords[2][2]
                    coords[0][2] = coords[0][2]

                    coords[1][0], coords[1][2] = ((-xPoints[11]/ratio)+(xPoints[0]/ratio))*(T-1)+xPoints[11]/ratio, -0.4
                    coords[3][0], coords[3][2] = ((xPoints[11]/ratio)-(xPoints[0]/ratio))*(T-0.5)+xPoints[0]/ratio, -0.4

                    T += speed
                elif T > 1.5 and T <= 2:
                    coords[0][0], coords[0][2] = Walk.bezier(T-1)
                    coords[3][0], coords[3][2] = Walk.bezier(2.5-T)
                    coords[0][2] = coords[0][2]
                    coords[3][2] = coords[3][2]

                    coords[1][0], coords[1][2] = ((-xPoints[11]/ratio)+(xPoints[0]/ratio))*(T-1)+xPoints[11]/ratio, -0.4
                    coords[2][0], coords[2][2] = ((xPoints[11]/ratio)-(xPoints[0]/ratio))*(T-1.5)+xPoints[0]/ratio, -0.4
...
#            #FR
            odrive_can_cmd(Joint.FR_hip.value, Commands.INPUT_POS.value, [0, 0, 0], 'fhh')
...
#            #BL
            odrive_can_cmd(Joint.BL_hip.value, Commands.INPUT_POS.value, [0, 0, 0], 'fhh')
...
#            #BR
            odrive_can_cmd(Joint.BR_hip.value, Commands.INPUT_POS.value, [0, 0, 0], 'fhh')
