...
def main():
    T= 0.00
    coords = np.array([[0.00, -0.10, -0.40],
                       [0.00,  0.10, -0.40],
                       [0.00, -0.10, -0.40],
                       [0.00,  0.10, -0.40]])
...
#                    i+=1
            ...
            if speed != 0 or angle != 0:
                if T <= 0:
                    ...
                    coords[0][0], coords[0][2] = Walk.bezier(T) #FR
                    coords[0][2] = coords[0][2]

                    coords[3][0], coords[3][2] = Walk.bezier(1-T) #BL
                    coords[3][2] = coords[3][2]

                    coords[1][0], coords[1][2] = ((-xPoints[11]/ratio)+(xPoints[0]/ratio))*T+xPoints[11]/ratio, -0.4 #FL
                    coords[2][0], coords[2][2] = ((xPoints[11]/ratio)-(xPoints[0]/ratio))*T+xPoints[0]/ratio, -0.4 #BR

                    T+=speed
                elif T > 1 and T <= 2:
                    coords[1][0], coords[1][2] = Walk.bezier(T-1)
                    coords[1][2] = coords[1][2]

                    coords[2][0], coords[2][2] = Walk.bezier(2-T)
                    coords[2][2] = coords[2][2]

                    coords[0][0], coords[0][2] = ((-xPoints[11]/ratio)+(xPoints[0]/ratio))*(T-1)+xPoints[11]/ratio, -0.4
                    coords[3][0], coords[3][2] = ((xPoints[11]/ratio)-(xPoints[0]/ratio))*(T-1)+xPoints[0]/ratio, -0.4
